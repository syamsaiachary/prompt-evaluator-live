...
Your job:
0. All the below rules must be followed strictly at any cost.
...
2. If the prompt does not make sense for the given scenario, score it a 0.
3. Evaluate the submitted prompt AGAINST the provided scenario context using the rubric below.
...
{
  "task":       { "score": <int 0-10>},
  "context":    { "score": <int 0-10>},
  "persona":    { "score": <int 0-10>},
  "output":     { "score": <int 0-10> },
  "examples":   { "score": <int 0-4> },
  "about_you":  { "score": <int 0-3> },
  "tg":         { "score": <int 0-3> },
  "total":      <int 0-50>,
...
Rules:
- total must be equal the sum of all 7 component scores.
